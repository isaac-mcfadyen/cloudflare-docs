...
Firebase Hosting does not ask for your build command, so if you are running a standard JavaScript set up, you will probably be using `yarn build` or a command specific to the framework or tool you are using (e.g., `ng build`).
